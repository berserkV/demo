node {
   ...
   // git url: 'https://github.globant.com/luis-delapena/hello-mvn.git'
    ...
    stage('config') {
        ...
        sh "export PATH=$PATH:/var/jenkins_home/workspace/g-t-mex-tp-java_pipeline/apache-maven-3.6.3/bin"
    }
    stage('Maven build') {
        sh "apache-maven-3.6.3/bin/mvn clean package -f /var/jenkins_home/workspace/g-t-mex-tp-java_pipeline"
